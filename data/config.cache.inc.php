...
$cfg_basehost = '/';
$cfg_cmspath = '';
$cfg_cookie_encode = 'YvFE4TshoO0rMisgi6KriqOCa7xA';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '陕西板式换热器，陕西换热站安装，西安换热机组，西安管壳式换热器，陕西鲁明热力设备工程有限公司';
$cfg_adminemail = '';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '陕西板式换热器，陕西换热站安装，西安换热机组，西安管壳式换热器';
$cfg_description = '陕西鲁明热力设备工程有限公司我公司是一家集环保设备研发、生产、销售以及工程设计、安装运行维护为一体的专业环保企业。公司主要致力于四大块业务：集中供热成套设备销售--水-水交换板式换热机组、汽-水交换的管壳式换热机组、热量表、散热器的销售；市政热力管网施工、换热站设备集成安装、调试交钥匙工程；供水成套设备销售--恒压变频供水设备、无负压供水设备、水处理成套销售、安装及售后服务；智能控制系统、热力控制柜、远传监控平台、就地控制柜的生产与销售。';
$cfg_beian = '陕ICP备14001283号-1';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
